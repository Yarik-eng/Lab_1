...
**Обгрунтування**: [опиши, які завдання виконав, з якими труднощами зіткнувся, що зрозумів про SELECT, WHERE, LIKE, логічні оператори, IN/BETWEEN/NULL, сортування та пагінацію]
